 ...
 * TODO: Tune PID!!!
 */
public class HardwareController_12_08_2017 {
    ////// Hardware Objects
    ...
    private void updateEncoders() {
        ...
        double leftFrontRotations = leftFrontTicks / 280;
        double leftRearRotations = leftRearTicks / 280;

        double rightFrontRotations = rightFrontTicks / 280;
        double rightRearRotations = rightRearTicks / 280;

        leftFrontWheelDistance = leftFrontRotations / 4;
        leftRearWheelDistance = leftRearRotations / 4;

        rightFrontWheelDistance = rightFrontRotations / 4;
        rightRearWheelDistance = rightRearRotations / 4;
