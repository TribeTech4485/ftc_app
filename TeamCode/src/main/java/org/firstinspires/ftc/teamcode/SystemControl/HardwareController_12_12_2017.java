 ...
 * TODO: Tune PID!!!
 */
public class HardwareController_12_12_2017 {
    ////// Hardware Objects
    ...
    // Values from left and right ODS
    ...
    // ENUMS
    public enum InitError {Success, MotorInit, ServoInit, GyroInit, ColorInit, RangeInit, ODS};
    public enum ControlError {Success, Drive, Servo, Gyro, Lift, Color, Range, ODS};
